...
public class ButtonChooseLevel extends Button{
	...
	public ButtonChooseLevel(float x, float y, float width, float height,
...
//			this.setImage(Helper.getImageFromAssets(AssetConstants.IMG_OPTIONS_PRESSED));
	...
	public ButtonChooseLevel(float x, float y, float width, float height, int zIndex) {
