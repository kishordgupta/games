...
public class BounceLevel8 extends BounceTest {
	...
	public BounceLevel8(int levelNumber, Result result) {
...
//		super.loadGameElements();
		...
		woodstock1 = new PhysicsBody(260*GameMenuInfo.ratio_w, 20*GameMenuInfo.ratio_h, 23*GameMenuInfo.ratio_w,23*GameMenuInfo.ratio_h,
				"/woodstock/woodstock.bin", AssetConstants.IMG_WOODSTOCK,
				"gfx\\woodstock1.png", world, (short) 14);
				addElement(woodstock1);
				woodstock2 = new PhysicsBody(280*GameMenuInfo.ratio_w, 25*GameMenuInfo.ratio_h, 23*GameMenuInfo.ratio_w,23*GameMenuInfo.ratio_h,
						"/woodstock/woodstock.bin", AssetConstants.IMG_WOODSTOCK,
						"gfx\\woodstock1.png", world, (short) 15);
						addElement(woodstock2);
						woodstock3 = new PhysicsBody(300*GameMenuInfo.ratio_w, 20*GameMenuInfo.ratio_h, 23*GameMenuInfo.ratio_w,23*GameMenuInfo.ratio_h,
								"/woodstock/woodstock.bin", AssetConstants.IMG_WOODSTOCK,
								"gfx\\woodstock1.png", world, (short) 16);
								addElement(woodstock3);
...
//		addElement(ground);
		...
		ground = new PhysicsBody(0, 20 * GameMenuInfo.ratio_h,
				480 * GameMenuInfo.ratio_w, 2 * GameMenuInfo.ratio_h,
				"/ground/ground.bin", AssetConstants.IMG_GROUND,
				"gfx\\ground.png", world, ((short) 3));
		background = new Background(0, 0, 480 * GameMenuInfo.ratio_w,
				22 * GameMenuInfo.ratio_h, 1, AssetConstants.IMG_GROUND);
		addElement(background);
