...
public class Settings_ButtonArnold extends Button{

	String imagePath_1, imagePath_2;

	public Settings_ButtonArnold(float x, float y, float width, float height,
	...
	public void onEvent(Point p) {
		...
		if(this.checkHit(p)){
			...
			GlobalVars.ge.loadStage(new SettingMenuArnold());		
		}
	}
