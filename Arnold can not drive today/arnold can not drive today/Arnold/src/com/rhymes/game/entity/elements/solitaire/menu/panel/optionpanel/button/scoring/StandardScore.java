...
public class StandardScore extends Button{
	private boolean active;
	String imagePath;
	
	public StandardScore(float x, float y, float width, float height, int zIndex,
			String imagePath) {
	...
	public String setImagePath(boolean active){
		if(active)
			this.imagePath = AssetConstants.score_standard_on;
		
		else
			this.imagePath = AssetConstants.score_standard_off;
