...
//				10,10, 0, 0, 0);
	...
	public void renderPathSegmentSimulation(PathNode n1, PathNode n2,
			TextureRegion ropeTexture) {
...
//		renderPathSegment(n1.getLocation(), n2.getLocation(), ropeTexture, pathWidth);
		rangle = Helper.getAngle(n1.getX(), n1.getY(), n2.getX(), n2.getY());
//		GlobalVars.ge.getRenderer().render(ropeTexture, n1.getX() * Helper.ratioX, n1.getY() * Helper.ratioY,
//				pathWidth  * Helper.ratioX, n1.getRightDistance() * Helper.ratioY, 0, 0, n1.getRightAngle());
		GlobalVars.ge.getRenderer().render(ropeTexture, n1.getX(), n1.getY(),
