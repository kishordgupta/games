...
import com.rhymes.game.entity.elements.menu.ButtonMapMode;
...
public class ModeMenu extends StageBase {
	...
	public AssetPack getAssets(AssetPack assetPack) {
		...
		assetPack.addTexture(AssetConstants.IMG_MAP_MODE);
		assetPack.addTexture(AssetConstants.IMG_MAP_MODE_PRESSED);

		assetPack.addTexture(AssetConstants.IMG_TIME_MODE);
		assetPack.addTexture(AssetConstants.IMG_TIME_MODE_PRESSED);

		assetPack.addTexture(AssetConstants.IMG_CLASSIC_MODE);
