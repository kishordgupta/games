...
public class ButtonSelectBall extends Button{
...
//			Helper.println("asse");
	...
	public ButtonSelectBall(float x, float y, float width, float height,
			int zIndex, String imagePath) {
		super(x, y, width, height, zIndex, imagePath);
	}
	public ButtonSelectBall(float x, float y, float width, float height,
			int zIndex, String imagePath,int bcb) {
		super(x, y, width, height, zIndex, imagePath);
		this.bcb = bcb;
	}
	public int getBcb() {
...
//		Helper.println("Checking hitpoint...");
		if(this.checkHit(p)){
			...
			((ChoosePlayerandBall)GlobalVars.ge.getCurrentStage()).selectBall(this);
...
//			GlobalVars.ge.loadStage(new ChoosePlayerandBall());			
	...
	public ButtonSelectBall(float x, float y, float width, float height, int zIndex) {
