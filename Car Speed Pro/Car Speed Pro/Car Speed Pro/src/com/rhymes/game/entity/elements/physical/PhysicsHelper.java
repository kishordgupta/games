...
public class PhysicsHelper {
	...
	public static final float BOX_STEP=/*0.0005f*/1/60f;
	public static final int  BOX_VELOCITY_ITERATIONS=100;
	public static final int BOX_POSITION_ITERATIONS=100;
