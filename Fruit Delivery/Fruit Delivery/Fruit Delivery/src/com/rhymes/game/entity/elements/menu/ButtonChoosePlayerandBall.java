...
public class ButtonChoosePlayerandBall extends Button{
	...
	public ButtonChoosePlayerandBall(float x, float y, float width, float height,
...
//			this.setImage(Helper.getImageFromAssets(AssetConstants.IMG_OPTIONS_PRESSED));
	...
	public ButtonChoosePlayerandBall(float x, float y, float width, float height, int zIndex) {
