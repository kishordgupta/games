...
public class Player3 extends Player {
	...
	public Player3(float x, float y, float width, float height,
			float rotateAngle, int zIndex) {
		super(x, y, width, height, rotateAngle, zIndex);
	}

	public Player3(float x, float y, float width, float height, int zIndex) {
	...
	public void init() {
		...
		imgNormal[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_NORMAL1);
		imgNormal[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_NORMAL2);
		imgThrow[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_THROW1);
		imgThrow[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_THROW2);
		imgEnd[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_END1);
		imgEnd[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER3_END2);
