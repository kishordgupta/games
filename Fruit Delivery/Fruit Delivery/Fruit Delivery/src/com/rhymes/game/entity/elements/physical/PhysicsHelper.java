...
public class PhysicsHelper {
	...
	public static final float BOX_STEP=/*0.0005f*/0.005f;
	public static final int  BOX_VELOCITY_ITERATIONS=180;
	public static final int BOX_POSITION_ITERATIONS=180;
