...
public class Player2 extends Player {
	...
	public Player2(float x, float y, float width, float height, int zIndex) {
	...
	public void init() {
		...
		imgNormal[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_NORMAL1);
		imgNormal[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_NORMAL2);
		// imgNormal[2] =
		// Helper.getImageFromAssets(AssetConstants.IMG_PLAYER_NORMAL1);
		imgThrow[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_THROW1);
		imgThrow[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_THROW2);
		imgEnd[0] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_END1);
		imgEnd[1] = Helper
				.getImageFromAssets(AssetConstants.IMG_PLAYER2_END2);
