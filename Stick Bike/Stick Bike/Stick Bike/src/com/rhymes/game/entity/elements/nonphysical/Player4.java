...
public class Player4 extends Player {
	...
	public Player4(float x, float y, float width, float height,
			float rotateAngle, int zIndex) {
		super(x, y, width, height, rotateAngle, zIndex);
	}

	public Player4(float x, float y, float width, float height, int zIndex) {
	...
	public void init() {
		...
		imgNormal[0] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_NORMAL1);
		imgNormal[1] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_NORMAL2);
		imgThrow[0] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_THROW1);
		imgThrow[1] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_THROW2);
		imgEnd[0] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_END1);
		imgEnd[1] = Helper.getImageFromAssets(AssetConstants.IMG_PLAYER4_END2);
