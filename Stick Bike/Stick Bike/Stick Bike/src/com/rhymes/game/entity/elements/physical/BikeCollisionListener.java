...
//		Helper.println("objectA body is::::"+objectA.getUserData()+ "and objectB body is::"+objectB.getUserData()+"and collided bodyB position is::"+PhysicsHelper.ConvertToWorld(objectB.getPosition().x)+"and y is:::"+(objectB.getPosition().y));
		...
		if((objectA.getUserData() == "riderBody")/*||(objectA.getUserData() == "leftAxleContainer")||(objectA.getUserData() == "rightAxleContainer")*/)
		{
		...
		else if((objectB.getUserData() == "riderBody")/*||(objectB.getUserData() == "leftAxleContainer")||(objectB.getUserData() == "rightAxleContainer")*/)
		{
